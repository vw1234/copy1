...
class Integration{
	...
	function getFriendsList($userid,$time) {
		$sql = ("select users.id userid, concat(users.firstname, ' ', users.lastname) username, 
                    users.username link, users.id avatar, cometchat_status.lastactivity,cometchat_status.lastseen, cometchat_status.lastseensetting, 
	...
	function getUserDetails($userid) {
		$sql = ("select users.id userid, concat(users.firstname, ' ', users.lastname) username, users.username link, users.id avatar, 
