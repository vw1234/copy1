...
(function($){
	...
	$.ccblock = (function () {
        ...
        return {
			...
			addCode: function() {
                    $('#cometchat_optionsbutton_popup .cometchat_optionstyle').append('<a class="cometchat_manage_blocklist" href="javascript:void(0);" onclick="manageBlockList()" style="margin:5px;">'+jqcc.ccblock.getLanguage('manage_blocked_users')+'</a>');
			},
