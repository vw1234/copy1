                            ...
                            if (data) {
                                ...
                                <?php if (USE_COMET != 1 || COMET_CHATROOMS != 1):?>
                                    if (typeof(jqcc[jqcc.cometchat.getChatroomVars('calleeAPI')].addChatroomMessage) == "function")
                                        jqcc[jqcc.cometchat.getChatroomVars('calleeAPI')].addChatroomMessage({fromid:jqcc.cometchat.getChatroomVars('myid'),message: message,id:data.id,selfadded:1,sent:Math.floor(new Date().getTime()),fromname:'0', calledfromsend:'1', roomid:currentroom});
                                <?php endif;?>
