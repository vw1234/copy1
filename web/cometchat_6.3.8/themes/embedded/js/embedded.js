        ...
        return {
            ...
            typingTo: function(item){
                if(typeof item['fromid'] != 'undefined'){
                    ...
                    var msg = jqcc[settings.theme].processMessage('<div id="cometchat_istyping_'+id+'" class="cometchat_messagebox"><div  class="cometchat_chatboxmessage_typing"><span class="cometchat_chatboxmessagecontent">'+notify_typing+'</span>'+fromavatar+'</div></div><div style="clear:both"></div>', '');
