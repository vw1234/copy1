...
$themeSettings['tab_border'] = setColorValue('tab_border','#666666',$parentColor);
...
$themeSettings['tab_title_backgroud_light'] = setColorValue('tab_title_backgroud_light','#D8F8FF',$parentColor);
$themeSettings['tab_title_background'] = setColorValue('tab_title_background','#3498DB',$parentColor);
$themeSettings['tab_title_gradient_start'] = setColorValue('tab_title_gradient_start','#61CADF',$parentColor);
$themeSettings['tab_title_gradient_center'] = setColorValue('tab_title_gradient_center','#3498DB',$parentColor);
$themeSettings['tab_title_gradient_end'] = setColorValue('tab_title_gradient_end','#3FAABE',$parentColor);
$themeSettings['tab_title_border'] = setColorValue('tab_title_border','#10798F',$parentColor);
