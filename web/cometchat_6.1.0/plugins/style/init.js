        ...
        return {
			...
			init: function (params) {
				...
				if(mobileDevice != null){
					loadCCPopup(baseUrl+'plugins/style/index.php?id='+id+'&basedata='+basedata, 'style',"status=0,toolbar=0,menubar=0,directories=0,resizable=0,location=0,status=0,scrollbars=0, width=260,height=130",260,80,'<?php echo $style_language[1];?>',null,null,null,null,1);
				} else {
