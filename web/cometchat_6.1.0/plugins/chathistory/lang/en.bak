...
${$addonname.'_language'}['no_previous_convo'] = setLanguageValue('no_previous_convo','No previous conversation to view',$lang,$addontype,$addonname);
${$addonname.'_language'}['no_more_convo'] = setLanguageValue('no_more_convo','See more conversation',$lang,$addontype,$addonname);
