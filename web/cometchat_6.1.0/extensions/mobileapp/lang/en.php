...
${$addonname.'_language'}['chatroom_user'] = setLanguageValue('chatroom_user','Chatroom user',$lang,$addontype,$addonname);
...
${$addonname.'_language'}['edit_status_msg'] = setLanguageValue('edit_status_msg','Edit status message',$lang,$addontype,$addonname);
${$addonname.'_language'}['status_message'] = setLanguageValue('status_message','Status message',$lang,$addontype,$addonname);
