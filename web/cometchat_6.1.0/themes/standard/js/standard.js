    ...
    $.ccstandard = (function(){
        ...
        return {
            ...
            createChatboxData: function(id, name, status, message, avatar, link, isdevice, silent, tryOldMessages){
                ...
                $("<div/>").attr("id", "cometchat_user_"+id+"_popup").addClass("cometchat_tabpopup").css('display', 'none').html('<div class="cometchat_tabtitle"><span id="cometchat_typing_'+id+'" class="cometchat_typing"></span><div class="cometchat_name" title="'+longname+'">'+startlink+longname+endlink+'</div></div><div class="cometchat_tabsubtitle">'+avatarsrc+'<div class="cometchat_message">'+message+'</div>'+pluginshtml+'<div style="clear:both"></div>'+'</div>'+prepend+'<div class="cometchat_tabcontent"><div class="cometchat_tabcontenttext" id="cometchat_tabcontenttext_'+id+'" onscroll="jqcc.'+settings.theme+'.chatScroll(\''+id+'\');">'+'</div><div class="cometchat_tabcontentinput"><textarea class="cometchat_textarea" placeholder="'+language[85]+'"></textarea><div class="cometchat_tabcontentsubmit"></div></div><div style="clear:both"></div></div>').appendTo($("#cometchat"));
                        ...
                        if(jqcc.cometchat.getThemeVariable('offline')==0){
                            ...
                            if(value!=jqcc.cometchat.getThemeVariable('openChatboxId')){
                                if(jqcc.cometchat.getThemeVariable('openChatboxId')!=''){
                                    ...
                                    olddata[jqcc.cometchat.getThemeVariable('openChatboxId')] = 1;
                                }
                                if(value!=''){
            ...
            addPopup: function(id, amount, add){
                if(jqcc.cometchat.getThemeArray('buddylistName', id)==null||jqcc.cometchat.getThemeArray('buddylistName', id)==''){
                    ...
                    if(amount==0){
                        ...
                        }else if(jqcc("#cometchat_user_"+id+".cometchat_usertabclick").length == 0){
            ...
            chatTab: function(){
                ...
                cometchat_search.keyup(function(){
                    ...
                    if(searchString.length>0&&searchString!=language[18]){
                        searchcount = cometchat_userscontent.find('div.cometchat_userlist').hide().parent().find('div.cometchat_userlist:icontains('+searchString+')').show().length;
                ...
                cometchat_userstab.click(function(){
                    ...
                    $('#cometchat_userstab_popup').css('left', baseLeft+barActualWidth-223-27);
            ...
            optionsButton: function(){
                ...
                cometchat_optionsbutton.click(function(){
                    ...
                    if(jqcc.cometchat.getThemeVariable('loggedout')==0){
                        ...
                        $('#cometchat_optionsbutton_popup').css('left', baseLeft+barActualWidth-223-27);
            ...
            closeModule: function(id){
                if($('#cometchat_trayicon_'+id+'_popup').length > 0 && $('#cometchat_trayicon_'+id+'_popup').hasClass('cometchat_tabopen')){
                    $("#cometchat_trayicon_"+id).click();
                } else {
            ...
            closeAllModule: function(lightboxClose){
                ...
                jqcc('#cometchat_base').find('#cometchat_trayicons').find('.cometchat_trayicon').each(function(){
                    jqcc(this).removeClass('cometchat_trayclick');
                });
                    ...
                    if(type=="messages"){
                        $.each(item, function(i, incoming){
                           ...
                           if(incoming.sent!=null){
                            ...
                            var separator = ':&nbsp;&nbsp;';
                            var msg = jqcc[settings.theme].processMessage('<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage" id="cometchat_message_'+incoming.id+'"><span class="cometchat_chatboxmessagefrom'+selfstyle+'"><strong>'+fromname+'</strong>'+separator+'</span><span class="cometchat_chatboxmessagecontent'+selfstyle+'">'+message+'</span><span id="cometchat_chatboxseen_'+incoming.id+'"></span>'+sentdata+'</div>', selfstyle);
